...
namespace EveOPreview
{
	...
	{
		private const string EXCEPTION_DUMP_FILE_NAME = "EVE-O Multiview.log";
		private const string EXCEPTION_MESSAGE = "EVE-O Multiview has encountered a problem and needs to close. Additional information has been saved in the crash log file.";
		...
		private void ExceptionEventHandler(Exception exception)
		{
			try
			{
				...
				MessageBox.Show(ExceptionHandler.EXCEPTION_MESSAGE, @"EVE-O Multiview", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
			catch
			{
